...
int N=90,M=90;   //N, the number of rows, M, the number of columns. L: the width of the frame.
...
for(iphi=0; iphi<Len_phis; iphi++){ 	
    ...
    strcat(filename,"TH90W90_map.dat");	strcat(filename2, "TH90W90_Clu.dat");
