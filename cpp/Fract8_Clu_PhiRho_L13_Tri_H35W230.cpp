...
double tau=1, tau_off=0, phi, rho=0, lambda=13, phi_deviation=0.0005;

//int height, width, heights[]={N},widths[]={M};
double phis[]={0.3613}, rhos[]={0, 0.3, 0.70};
...
for(iphi=0; iphi<Len_phis; iphi++){ 	
    ...
    strcat(filename,"TH35W230_L13_map.dat");	strcat(filename2, "TH35W230_L13_Clu.dat");
