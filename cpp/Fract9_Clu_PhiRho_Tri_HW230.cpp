...
int N=230,M=230;   //N, the number of rows, M, the number of columns. L: the width of the frame.
...
for(iphi=0; iphi<Len_phis; iphi++){ 	
    ...
    strcat(filename,"THW230_map.dat");	strcat(filename2, "THW230_Clu.dat");
