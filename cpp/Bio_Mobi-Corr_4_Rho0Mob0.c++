...
int main(){
    ...
    double phi=0.43, rho_dynamic=0, rho_spatial=0.17, mobilities[]= { 0 }; //mobility=0.36, the rho_spatial is 0.1712
    ...
    //for( int i=0; i< sizeof(mobilities)/sizeof(mobilities[0] ); ++i){
        ...
        for(int irepeat=0; irepeat<repeats; ++irepeat){
            ...
            if(irepeat==0)
                biofilm.print( "/home/xiaoling/correlated_percolation/data/Bio4_biofilm_Rho0Mob0.dat" );
        }
        for(int i=0; i<hei_bio; ++i)
    ...
    printVector<double>(covariance_y, "/home/xiaoling/correlated_percolation/data/Bio4_CF_y_r10000_Rho0Mob0.dat");
    printVector<double>(covariance_x, "/home/xiaoling/correlated_percolation/data/Bio4_CF_x_r10000_Rho0Mob0.dat");
