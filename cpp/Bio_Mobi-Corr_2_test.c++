...
int main(){
    int hei_bio= 4, wid_bio= 4, repeats=1;
    ...
    //for( int i=0; i< sizeof(mobilities)/sizeof(mobilities[0] ); ++i){
        ...
        for(int irepeat=0; irepeat<repeats; ++irepeat){
            ...
            if(irepeat==0)
                biofilm.print( "/home/xiaoling/correlated_percolation/test/biofilm_test.dat" );
    ...
    printVector<double>(covariance_y, "/home/xiaoling/correlated_percolation/data/covariance_height_test.dat");
    printVector<double>(covariance_x, "/home/xiaoling/correlated_percolation/data/covariance_width_test.dat");
