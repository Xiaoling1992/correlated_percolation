...
int N=152,M=1000;   //N, the number of rows, M, the number of columns. L: the width of the frame.
...
for(irho=0; irho< Len_rhos; irho++){
	...
	strcat(filename, "_TH152W1000.dat");	
...
for(iphi=0; iphi<Len_phis; iphi++){ 	
    ...
    strcat(filename,"TH152W1000_map.dat");	strcat(filename2, "TH152W1000_Clu.dat");
