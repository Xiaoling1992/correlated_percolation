...
double tau=1, tau_off=0, phi, rho=0, lambda=21, phi_deviation=0.0005;

//int height, width, heights[]={N},widths[]={M};
double phis[]={0.2609}, rhos[]={0, 0.3, 0.70};
...
for(iphi=0; iphi<Len_phis; iphi++){ 	
    ...
    strcat(filename,"TH35W230_L21_map.dat");	strcat(filename2, "TH35W230_L21_Clu.dat");
