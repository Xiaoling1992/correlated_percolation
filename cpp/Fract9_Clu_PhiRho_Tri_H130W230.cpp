...
int N=130,M=230;   //N, the number of rows, M, the number of columns. L: the width of the frame.
...
for(irho=0; irho< Len_rhos; irho++){
	...
	strcat(filename, "_TH130W230.dat");	
...
for(iphi=0; iphi<Len_phis; iphi++){ 	
    ...
    strcat(filename,"TH130W230_map.dat");	strcat(filename2, "TH130W230_Clu.dat");
