...
int N=105,M=230;   //N, the number of rows, M, the number of columns. L: the width of the frame.
...
double phis[]={0.43, 0.5}, rhos[]={0.0, 0.1, 0.17, 0.2, 0.3, 0.38, 0.4, 0.5, 0.6, 0.7, 0.8, 0.9};
...
for(irho=0; irho< Len_rhos; irho++){
	...
	strcat(filename, "_TH105W1025.dat");	
...
for(iphi=0; iphi<Len_phis; iphi++){ 	
    ...
    strcat(filename,"TH105W230_map.dat");	strcat(filename2, "TH105W230_Clu.dat");
