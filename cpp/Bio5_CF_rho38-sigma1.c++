...
int main(){
    ...
    double phi=0.43, rho_dynamic=0.38, rho_spatial=0.17, sigmas[]= {1}; 
    ...
    //for( int i=0; i< sizeof(mobilities)/sizeof(mobilities[0] ); ++i){
        ...
        for(int irepeat=0; irepeat<repeats; ++irepeat){
            ...
            Biofilm<int> biofilm(hei_bio, wid_bio, 1, 0, 2, 1);  //hei_bio, wid_bio, on, off, hei_cell, wid_cell
            int num_cells= biofilm.generateBiofilm_GR(phi, rho_dynamic, 1.0, sigmas[0], 1.0/3.0, 1.0/3.0);
            //int num_cells= biofilm.generateBiofilm_GR(phi, rho_dynamic, 1.0, sigmas[i], 0, 0);
            ...
            if(irepeat==0)
                biofilm.print( "/home/xiaoling/correlated_percolation/data/Bio5_biofilm_Rho38Sigma1.dat" );
        }
        for(int i=0; i<hei_bio; ++i)
    ...
    printVector<double>(covariance_y, "/home/xiaoling/correlated_percolation/data/Bio5_CF_y_r3000_Rho38Sigma1.dat");
    printVector<double>(covariance_x, "/home/xiaoling/correlated_percolation/data/Bio5_CF_x_r3000_Rho38Sigma1.dat");
