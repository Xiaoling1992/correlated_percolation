//3. when exchange rate is 0.4, rho_spatial=0.17. Now set exchange rate to be 0.4, visualize the correlation length.
...
int main(){
    ...
    double phi=0.43, rho_dynamic=0, rho_spatial=0, mobilities[]= {0}; 
    ...
    //for( int i=0; i< sizeof(mobilities)/sizeof(mobilities[0] ); ++i){
        ...
        for(int irepeat=0; irepeat<repeats; ++irepeat){
            ...
            covariance_y_tem= biofilm.measureCoVarY();
            covariance_x_tem= biofilm.measureCoVarX();
            ...
            if(irepeat==0)
                biofilm.print( "/home/xiaoling/correlated_percolation/data/biofilm_rand.dat" );
        }
        for(int i=0; i<hei_bio; ++i)
    ...
    printVector<double>(covariance_y, "/home/xiaoling/correlated_percolation/data/covariance_height_rand_r1000.dat");
    printVector<double>(covariance_x, "/home/xiaoling/correlated_percolation/data/covariance_width_rand_r1000.dat");
