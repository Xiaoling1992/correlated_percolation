...
int main(){
    ...
    double phi=0.43, rho_dynamic=0, rho_spatial=0.17, sigmas[]= { 0.0}; 
    ...
    //for( int i=0; i< sizeof(mobilities)/sizeof(mobilities[0] ); ++i){
        ...
        for(int irepeat=0; irepeat<repeats; ++irepeat){
            ...
            if(irepeat==0)
                biofilm.print( "/home/xiaoling/correlated_percolation/data/Bio5_biofilm_Rho0Sigma0.dat" );
        }
        for(int i=0; i<hei_bio; ++i)
    ...
    printVector<double>(covariance_y, "/home/xiaoling/correlated_percolation/data/Bio5_CF_y_r3000_Rho0Sigma0.dat");
    printVector<double>(covariance_x, "/home/xiaoling/correlated_percolation/data/Bio5_CF_x_r3000_Rho0Sigma0.dat");
