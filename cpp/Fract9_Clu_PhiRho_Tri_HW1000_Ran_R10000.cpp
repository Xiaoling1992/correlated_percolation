...
double tau=1, tau_off=0, phi, rho=0, phi_deviation=0.0005;

//int height, width, heights[]={N},widths[]={M};
double phis[]={0.5}, rhos[]={0.0};


int  Len_phis=sizeof(phis)/sizeof(phis[0]), Len_rhos=sizeof(rhos)/sizeof(rhos[0]), NumRep=10000;
...
for(irho=0; irho< Len_rhos; irho++){
	...
	strcat(filename, "_THW1000_Ran_R10000.dat");	
...
for(iphi=0; iphi<Len_phis; iphi++){ 	
    ...
    strcat(filename,"THW1000_map_Ran_R10000.dat");	strcat(filename2, "THW1000_Clu_Ran_R10000.dat");
