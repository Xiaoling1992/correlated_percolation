//_3. Visualize the correlation function: same: 1, different, -1;
...
int main(){
    ...
    double phi=0.43, rho_dynamic=0, rho_spatial=0.17, mobilities[]= {0}; 
    ...
    //for( int i=0; i< sizeof(mobilities)/sizeof(mobilities[0] ); ++i){
        ...
        for(int irepeat=0; irepeat<repeats; ++irepeat){
            ...
            if(irepeat==0)
                biofilm.print( "/home/xiaoling/correlated_percolation/data/biofilm_rho0_mob40.dat" );
        }
        for(int i=0; i<hei_bio; ++i)
    ...
    printVector<double>(covariance_y, "/home/xiaoling/correlated_percolation/data/covfun_height_rho0_r1000.dat");
    printVector<double>(covariance_x, "/home/xiaoling/correlated_percolation/data/covfun_width_rho0_r1000.dat");
